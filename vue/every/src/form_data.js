...
const formData = {
    pipe_diameter_velocity: {
        ...
        has_total_row: false,
        method: function () {
            if (!verifyArg(this.args.flowrate_volume.value,
                this.args.velocity.value)) {
                alert('输入数据错误!');
                return;
            }
            const pipe = new Pipe();
    ...
    pipe_diameter_drop_pressure: {
        ...
        method: function () {
            ...
            this.results.di.value =
                pipe.diameter_pressureDrop(this.args.length.value,
    ...
    pipe_drop_pressure: {
        ...
        method: function () {
            ...
            [
                ...
                k += this.args[val].k * this.args[val].value;
            });
    ...
    pipe_weight: {
        ...
        method() {
            ...
            const pipe = new Pipe();
            pipe.do_ = this.args.do_.value;
            pipe.thk = this.args.thk.value;
            pipe.density = this.args.density.value;
            pipe.length = this.args.length.value;
 ...
 * @return {bool} true for verified
 */
function verifyArg(...args) {
